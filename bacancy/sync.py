        ...
        "Item Group": [
            {
                ...
                "mandatory_depends_on": (
                    "eval: doc.parent_item_group === frappe.boot.root_item_group"
                ),
    ...
    property_setters = [
        {
            ...
            "value": "eval: doc.parent_item_group === frappe.boot.root_item_group",
        },
        {
            "doctype": "Item Group",
            "fieldname": "parent_item_group",
            "property": "mandatory_depends_on",
            "value": "eval: doc.name !== frappe.boot.root_item_group",
        },
    ]
